...
join -1 1 -2 1 <(sort $SNa"_S"$SNo"_L"$LNo$"_out6_TExGENES_readnames.txt") <(zcat < $SNa"_S"$SNo"_L"$LNo$"_LOOKUP.sorted.tsv.gz") > $SNa"_S"$SNo"_L"$LNo$"_out7_TExGENES_longreads.tsv" &&
